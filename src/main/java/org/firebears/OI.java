...
public class OI {
    ...
    private final JoystickButton indexButton; // 11
    private final JoystickButton emergencyStopButton;
    ...
    public OI() {
       ...
       // raiseAcqButton.whenPressed(new AcquisitionRaiseCommand(Robot.acquisition, Robot.loader, true));
        ...
        emergencyStopButton = new JoystickButton(buttonBox, 7);
        emergencyStopButton.whenPressed(new AhhhItsJammedCommand());
